...
type BiopayProjectContentProps = {
  showFooterLogo?: boolean;
};

export function BiopayProjectContent({ showFooterLogo = true }: BiopayProjectContentProps) {
  return (
    <main className={`${styles.page} ${styles.biopayPage}`}>
      <div className={styles.grid}>
        ...
        <section className={styles.rightCol}>
          <p>
            Biopay represents the initial ideation phase in the development of the Biotap ecosystem,
            where the core vision was first defined: enabling secure, fast, and identity-based digital
            transactions.
            {'\n\n'}
            At its core, Biopay explored the idea of removing traditional payment barriers such as
            passwords, cards, and manual verification, replacing them with biometric and
            identity-linked authentication methods. This concept was built around trust, speed, and
            accessibility in digital financial interactions.
          </p>
          <p>
            As the idea evolved, the brand transitioned from Biopay to Biotap to better reflect a
            broader vision—moving beyond payments into a more unified identity and interaction system.
            This shift marked a critical stage in the brand identity journey, where naming, positioning,
            and user experience direction were refined to support long-term scalability.
          </p>
        </section>
      </div>
